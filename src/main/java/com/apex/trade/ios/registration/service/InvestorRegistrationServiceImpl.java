...
public class InvestorRegistrationServiceImpl implements InvestorRegistrationService {
    ...
    public Investor registerInvestor(InvestorRegistrationRequest request) {
        ...
        investor.setNominee(investor.getNominee());
        investor.setType(investor.getType());
        investor.setRole(investor.getRole());
        Role role = roleRepository.findByName("NEW_INDIVIDUAL_INVESTOR").orElseThrow(() -> new RuntimeException("Default role not found"));
